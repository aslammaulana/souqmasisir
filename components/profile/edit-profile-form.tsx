...
export default function EditProfileForm({ initialData }: { initialData: InitialData }) {
    ...
    const parsedPhone = initialData.phone ? parsePhone(initialData.phone) : { dialCode: "+62", local: "" };
                    ...
                    <div className="relative w-20 h-20 mb-6">
                        <div className="w-20 h-20 rounded-full overflow-hidden bg-blue-100">
                            {initialData.avatarUrl ? (
                                <Image src={initialData.avatarUrl} alt="Avatar" width={80} height={80} className="object-cover w-full h-full" />
                            ) : (
